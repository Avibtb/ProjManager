...
public class TaskResource {
	...
	public String createTask(@Validated Task task, BindingResult bindingResult) {
	...
	public String updateTask(@Validated Task task, BindingResult bindingResult, @PathVariable Long id, Model model) {
		if (bindingResult.hasErrors()) {
			return "forms/task-edit";
		}
